...
public partial class OnlineCourseDbContext : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("Server=DESKTOP-FTGKJKJ;Initial Catalog=OnlineCourseDB;Integrated Security=SSPI; MultipleActiveResultSets=true;TrustServerCertificate=True;");
